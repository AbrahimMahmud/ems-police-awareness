...
run calib1000_C1   12 0,1 python3 18_null_calibration.py --stratum C1 --sims 1000 --draws 200
run calib1000_disc 12 0,1 python3 18_null_calibration.py --stratum discovery --sims 1000 --draws 200
run calib1000_C2   12 0,1 python3 18_null_calibration.py --stratum C2 --sims 1000 --draws 200
